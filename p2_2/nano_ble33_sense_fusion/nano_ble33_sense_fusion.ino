...
/* Includes ---------------------------------------------------------------- */
#include <MovementDetect_inferencing.h>
...
void loop()
{
    ...
    for (size_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
        ...
        if (value > 0.75f) {
            ...
            if (strcmp(label, "RollPos") == 0) {
                ei_printf(">> Color: ROJO\n");
                digitalWrite(LEDR, LOW);
            }
            else if (strcmp(label, "RollNeg") == 0) {
                ei_printf(">> Color: ROSA\n");
                digitalWrite(LEDR, LOW);
                digitalWrite(LEDB, LOW);  // rojo + azul
            }
            else if (strcmp(label, "PitPos") == 0) {
                ei_printf(">> Color: VERDE\n");
                digitalWrite(LEDG, LOW);
            }
            else if (strcmp(label, "PitNeg") == 0) {
                ei_printf(">> Color: AMARILLO\n");
                digitalWrite(LEDR, LOW);
                digitalWrite(LEDG, LOW);  // rojo + verde
            }
            else if (strcmp(label, "YawPos") == 0) {
                ei_printf(">> Color: AZUL\n");
                digitalWrite(LEDB, LOW);
            }
            else if (strcmp(label, "YawNeg") == 0) {
                ei_printf(">> Color: MORADO\n");
                digitalWrite(LEDR, LOW);
                digitalWrite(LEDB, LOW);  // rojo + azul
            }
        }
